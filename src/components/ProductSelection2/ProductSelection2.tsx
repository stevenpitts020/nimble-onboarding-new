...
const ProductSelection2: React.FunctionComponent = () => {
  const onClick = (e) => {
    console.log("click ", e);
  };
...
export default ProductSelection2;
